...
import com.example.todotask.util.Constants;
...
//        Log.d("DBHandler", "added Item: ");
    ...
    public Item getItem(int id) {
        ...
        if (cursor != null) {
            ...
            item.setItemQuantity(String.valueOf(cursor.getInt(cursor.getColumnIndex(Constants.KEY_QTY_NUMBER))));
            item.setItemSize(String.valueOf(cursor.getInt(cursor.getColumnIndex(Constants.KEY_ITEM_SIZE))));
