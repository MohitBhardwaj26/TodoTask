...
import com.example.todotask.data.DatabaseHandler;
import com.example.todotask.model.Item;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemName.setText(MessageFormat.format("Task: {0}", item.getItemName()));
        viewHolder.itemColor.setText(MessageFormat.format("Start Time: {0}", item.getItemColor()));
        viewHolder.quantity.setText(MessageFormat.format("Total Time: {0}", item.getItemQuantity()));
        viewHolder.size.setText(MessageFormat.format("Finish Time: {0}", item.getItemSize()));
